...
--    /////   ////// ///    ///  ////// ///  /////  ///     ////////   //      //  // ///   //  /////
    ...
    if tradeSkillName == "Jewelcrafting" then
        ...
        elseif rank > 29 and rank < 50 then -- 30-49
            shouldCraft = "Tigerseye Band";
            shouldCraftRecipe = "1x Tigerseye, 1x Delicate Copper Wire";
        ...
        elseif rank > 79 and rank < 100 then -- 80-99 # Add alts
            shouldCraft = "Simple Pearl Ring";
            shouldCraftRecipe = "1x Small Lustrous Pearl, 1x Bronze Setting, 2x Copper Bar";
        elseif rank > 99 and rank < 110 then -- 100-109
        ...
        elseif rank > 279 and rank < 290 then -- 280-289
            shouldCraft = "Onslaught Ring"; -- TODO add "Sapphire Pendant of Winter Night"
            shouldCraftRecipe = "1x Powerful Mojo, 1x Essence of Earth, 1x Thorium Setting";
        ...
        elseif rank > 299 and rank < 320 then -- 300-319
            shouldCraft = "Teardrop Blood Garnet"; -- TODO add Brilliant Golden Draenite ## Solid Azure Moonstone ## Radiant Deep Peridot ## Inscribed Flame Spessarite ## Glowing Shadow Draenite
            shouldCraftRecipe = "1x Blood Garnet";
        elseif rank > 319 and rank < 325 then -- 320-324
            shouldCraft = "Bold Blood Garnet"; -- TODO add Bright Blood Garnet ## Gleaming Golden Draenite ## Jagged Deep Peridot ## Luminous Flame Spessarite ## Royal Shadow Draenite ## Sparkling Azure Moonstone
            shouldCraftRecipe = "1x Blood Garnet";
        elseif rank > 324 and rank < 335 then -- 325-334
            shouldCraft = "Mercurial Adamantite";
            shouldCraftRecipe = "4x Adamantite Powder, 1x Primal Earth";
        elseif rank > 334 and rank < 340 then -- 335-339
            shouldCraft = "Dazzling Deep Peridot"; -- TODO add Delicate Blood Garnet ## Potent Flame Spessarite
            shouldCraftRecipe = "1x Deep Peridot"; -- TODO add note "sold by <NPC>"
        elseif rank > 339 and rank < 350 then -- 340-349
        ...
        elseif rank > 349 and rank < 395 then -- 350-394
            shouldCraft = "Bold Bloodstone"; -- TODO add note "or any equivalent gem from Bloodstone, Chalcedony, Dark Jade, Huge Citrine, Shadow Crystal, Sun Crystal"
            shouldCraftRecipe = "Bloodstone";
        elseif rank > 394 and rank < 400 then -- 395-399
            shouldCraft = "Bloodstone Band"; -- TODO add Crystal Chalcedony Amulet  ## Crystal Citrine Necklace ## Sun Rock Ring
            shouldCraftRecipe = "1x Bloodstone, 2x Crystallized Earth";
        elseif rank > 399 and rank < 420 then -- 400-419
            shouldCraft = "Stoneguard Band"; -- TODO add  Shadowmight Ring
            shouldCraftRecipe = "2x Eternal Earth";
        elseif rank > 419 and rank < 425 then -- 420-424
            shouldCraft = "Dazzling Forest Emerald";
            shouldCraftRecipe = "1x Forest Emerald";
        elseif rank > 424 and rank < 450 then -- 425-449
            shouldCraft = "Enigmatic Skyflare Diamond"; -- TODO add note "or any equivalent gem from Skyflare Diamond or Earthsiege Diamond". also is a reference to TERA's variations of enigmatic scrolls
            shouldCraftRecipe = "Skyflare Diamond";
        elseif rank == 450 then
            shouldCraft = "unknown";
            shouldCraftRecipe = "unknown";
        end
